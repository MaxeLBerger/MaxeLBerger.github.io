...
(function () {
    ...
    const translations = {
        de: {
            ...
            // Imkerei Feuerstein: MVP, Livegang mit Bestellsystem in Vorbereitung
            'slide.imkerei.t1': 'Imkerei Feuerstein',
            'slide.imkerei.t2': 'Relaunch',
            'slide.imkerei.t3': 'als MVP.',
            'slide.imkerei.desc': 'MVP: Relaunch-Website mit Shop-Oberfläche für die Familienimkerei Feuerstein aus Elchingen. 122 statisch erzeugte Seiten, 103 Produkte mit Suche und Filter, Warenkorb, Galerie und FAQ. Der Livegang mit angebundenem Bestellsystem ist in Vorbereitung.',
            'slide.imkerei.cta1': 'MVP ansehen',
            'slide.imkerei.cta2': 'Projekt-Details',
            'slide.imkerei.tag1': 'Astro',
            ...
            'slide.senihelp24.desc': 'Neuer Web-Auftritt für senihelp24.pl. Aktuell in Entwicklung, eines der ersten Projekte zum Start meiner Selbstständigkeit am 1. Oktober 2026.',
            ...
            'about.p1a': 'Ich bin in Bruckmühl aufgewachsen, und hier hat sich auch meine Autoliebe entwickelt. Derzeit habe ich zwei alte BMWs (',
            'about.p1link': 'E46',
            'about.p1b': '), die ich mit echter Liebe hege und pflege.',
            'about.p2': '2020 habe ich mit dem Programmieren angefangen, zuerst mit kleinen Websites, danach mit Java. 2022 folgte die Ausbildung zum Softwareentwickler, vor allem mit Delphi und Datenbanken. In der Zeit bin ich bei KI hängen geblieben. Heute arbeite ich in fast jedem Projekt mit Claude Code, Codex oder Copilot, und mit AI Captain habe ich eine eigene Extension für VS Code und Claude gebaut. Kollegen habe ich bereits mehrfach in internen Workshops gezeigt, wie man AI Agents sinnvoll einsetzt.',
            'about.p3': 'Für Unternehmen und Selbstständige aus der Region entwickle ich Websites und Web-Apps, wo es passt, auch Automatisierungen mit KI. Ansprechpartner bin ich dabei selbst, vom ersten Gespräch bis die Seite online ist.',
            'about.p4': 'Ich kann richtig gut mit Menschen und habe viel Empathie, auch wenn man das einem ITler und Autisten vielleicht nicht zutraut.',
            'about.p5': 'Zum Ausgleich spiele ich Fußball und gehe ins Gym. Ich gehe gerne spazieren und mache auch mal gar nichts, das brauche ich nach 12 Stunden am PC.',
            'contact.tag': 'Kontakt',
            ...
            'slide.danielbrecheis.desc': 'Markenwebsite für Daniel Brecheis (Human Bridges Consulting): HR-Coaching, Workshops und Interim-Management. Aktuell in Entwicklung, live zum Start meiner Selbstständigkeit am 1. Oktober 2026.',
            ...
            // Aurevia (Spielkonzept, KI-Keyart, spielbarer Prototyp in Arbeit)
            'slide.aurevia.t1': 'Aurevia.',
            'slide.aurevia.t2': 'Gemeinsam jenseits',
            'slide.aurevia.t3': 'der Kavernen.',
            'slide.aurevia.badge': 'SPIELKONZEPT',
            'slide.aurevia.desc': 'Aurevia ist ein Spielkonzept für ein kooperatives Fantasy-Abenteuer jenseits unterirdischer Kavernen: KI-generiertes Keyart, eigenes UI-Design für Hauptmenü, Spielstand und Steuerungshinweise. Ein spielbarer Prototyp ist in Arbeit, dieser Screen zeigt die visuelle Richtung.',
            'slide.aurevia.cta1': 'Projekt anfragen',
            'slide.aurevia.cta2': 'In Arbeit',
            'slide.aurevia.tag1': 'Spielkonzept',
            'slide.aurevia.tag2': 'KI-Keyart',
            'slide.aurevia.tag3': 'UI-Design',
        ...
        en: {
            ...
            'slide.albert.tag2': 'TypeScript',
            'slide.albert.tag3': 'Neural Net',
            // Imkerei Feuerstein: MVP, launch with ordering system in preparation
            'slide.imkerei.t1': 'Imkerei Feuerstein',
            'slide.imkerei.t2': 'Relaunch',
            'slide.imkerei.t3': 'as an MVP.',
            'slide.imkerei.desc': 'MVP: a relaunch website with a shop interface for the Feuerstein family apiary in Elchingen. 122 statically generated pages, 103 products with search and filters, a shopping cart, gallery and FAQ. The launch with a connected ordering system is being prepared.',
            'slide.imkerei.cta1': 'View the MVP',
            ...
            'slide.senihelp24.desc': 'A new web presence for senihelp24.pl. Currently in development, one of the first projects for the start of my self-employment on 1 October 2026.',
            ...
            'about.p1a': 'I grew up in Bruckmühl, and that is also where my love for cars began. Right now I have two old BMWs (',
            'about.p1link': 'E46',
            'about.p1b': '), which I look after with real love.',
            'about.p2': 'I started programming in 2020, first with small websites, then with Java. In 2022 I began my apprenticeship as a software developer, mostly working with Delphi and databases. That is when I got hooked on AI. Today I use Claude Code, Codex or Copilot in almost every project, and with AI Captain I built my own extension for VS Code and Claude. I have already shown colleagues in several internal workshops how to put AI agents to good use.',
            'about.p3': 'For businesses and self-employed people in the region I build websites and web apps, and where it fits, AI automations too. You deal with me directly, from the first conversation until the site is online.',
            'about.p4': 'I am really good with people and have a lot of empathy, even if you might not expect that from someone who works in IT and is autistic.',
            'about.p5': 'To balance things out, I play football and go to the gym. I also like going for walks and sometimes doing nothing at all, which I need after 12 hours at the PC.',
            'contact.tag': 'Contact',
            ...
            'slide.danielbrecheis.desc': 'Brand website for Daniel Brecheis (Human Bridges Consulting): HR coaching, workshops and interim management. Currently in development, going live with the start of my self-employment on 1 October 2026.',
            ...
            'slide.ageofmax.tag2': 'TypeScript',
            'slide.ageofmax.tag3': 'Vite',
            // Aurevia (game concept, AI key art, playable prototype in progress)
            'slide.aurevia.t1': 'Aurevia.',
            'slide.aurevia.t2': 'Together, beyond',
            'slide.aurevia.t3': 'the caverns.',
            'slide.aurevia.badge': 'GAME CONCEPT',
            'slide.aurevia.desc': 'Aurevia is a game concept for a cooperative fantasy adventure beyond underground caverns: AI-generated key art, custom UI design for the main menu, save state and control hints. A playable prototype is in progress; this screen shows the visual direction.',
            'slide.aurevia.cta1': 'Ask about this',
            'slide.aurevia.cta2': 'Work in progress',
            'slide.aurevia.tag1': 'Game concept',
            'slide.aurevia.tag2': 'AI key art',
            'slide.aurevia.tag3': 'UI design',
