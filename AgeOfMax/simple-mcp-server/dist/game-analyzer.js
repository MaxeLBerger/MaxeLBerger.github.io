...
export class GameAnalyzer {
    ...
    loadIssues() {
        try {
            ...
            const issues = parsed.analysis?.missing_features || [];
            const byPriority = {
...
`;
     ...
     */
    createIssueFiles(outputDir = './generated-issues') {
        const analysis = this.loadIssues();
...
//# sourceMappingURL=game-analyzer.js.map