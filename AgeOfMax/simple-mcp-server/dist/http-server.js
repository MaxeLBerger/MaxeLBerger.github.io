...
// ===== GAME ANALYSIS TOOLS =====
// Analyze all issues
server.registerTool('analyze-game', {
...
server.registerTool('get-issues-by-priority', {
...
server.registerTool('get-issues-by-category', {
...
server.registerTool('generate-fix', {
...
server.registerTool('create-issue-files', {
